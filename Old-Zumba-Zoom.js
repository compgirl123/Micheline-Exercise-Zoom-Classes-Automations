...
function recordingsAutomation(){
  ...
  var query = "https://api.zoom.us/v2/users/XXXXXX/recordings?from="+'2020-11-18'+"&to="+'2020-11-18'+"";
  Logger.log(query);
...
function sendBulkEmails(){
  ...
  var create_id_2 = UrlFetchApp.fetch(
      "https://api.zoom.us/v2/users/XXXXXX/meetings?from="+formattedDate+"&to="+'2021-05-22'+"&page_size=30", {
        "method" : "GET",
        "muteHttpExceptions" : true,
        headers: {
        "Authorization": "Bearer XXXXXX",
