...
function getCalendarZoomEvent(){
  ...
  var sat_date_object = getWednesday().toString(); // Ex: Thurs oct 7
  var fri_date_object = getTuesday().toString(); // Ex: Fri oct 8
...
function sendMeetingDetailsUsers(){
  ...
  var email_body_fr = "<!DOCTYPE html><html><body><h1>Micheline Zoom Zumba Class</h1><br/><br/>Bonjour la Gang de Zumba,<br><br> Je m'appelle Claudia Feochari et je\
                              ...
                              de me contacter par courriel si vous avez des questions.<br>Voici les détails pour le meeting Zoom ce Mardi:<br>"+"Meeting Id: "
  ...
  var email_body_en = "<br><br>Hi Everyone,<br><br>I'm Claudia Feochari, Micheline's daughter and Zoom Zumba with Micheline IT Manager. I am emailing you to remind\
                              ...
                              form of a Zoom call for this.<br>Here are the details for Tuesday’s Meeting:<br>" +"Meeting Id: "+email_details[0]+ "<br> Password: " +email_details[1]+"<br>" +
...
function getEmailsForRecordingSend(){
  ...
  var recordingsArray = [];
  var emailsRecording = [];
  var fri_date_object = getTuesday(); // Ex: Fri oct 8
